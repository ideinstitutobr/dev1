<?php
/**
 * Script de Migration: Adicionar campo finalizado_em
 * Acesse via navegador: /public/checklist/migrate_finalizado_em.php
 *
...
<head>
    ...
    <title>Migration - Finalizado Em</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>🔄 Migration: Adicionar Campo finalizado_em</h1>
        ...
        try {
            ...
            $stmt = $pdo->query("SHOW COLUMNS FROM checklists LIKE 'finalizado_em'");
            $columnExists = $stmt->fetch();

            if ($columnExists) {
                echo "<div class='success'>";
                echo "<h3>✓ Migration Já Executada</h3>";
                echo "<p>A coluna 'finalizado_em' já existe na tabela checklists.</p>";
                ...
                // Adicionar coluna finalizado_em
                $sql1 = "ALTER TABLE checklists
                        ADD COLUMN finalizado_em DATETIME NULL AFTER updated_at";

                $pdo->exec($sql1);
                echo "<div class='success'>✓ Coluna 'finalizado_em' adicionada com sucesso</div>";

                // Criar índice
                $sql2 = "CREATE INDEX idx_finalizado_em ON checklists(finalizado_em)";
                $pdo->exec($sql2);
                echo "<div class='success'>✓ Índice 'idx_finalizado_em' criado com sucesso</div>";
            ...
            echo "<h3>Estrutura Atual da Tabela checklists:</h3>";
            ...
            echo "<pre>rm public/checklist/migrate_finalizado_em.php</pre>";
            echo "</div>";
