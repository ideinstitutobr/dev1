<?php
/**
 * Página: Gestão de Perguntas Quinzenal/Mensals
 * Lista todas as perguntas de formulários quinzenais/mensais
 */
...
$perguntas = $perguntaModel->listarPorTipo('quinzenal_mensal', true);
$modulos = $moduloModel->listarAtivos('quinzenal_mensal', true);

$pageTitle = 'Gestão de Perguntas Quinzenal/Mensals';
...
<div class="container">
    <div class="header">
        <h1>📝 Gestão de Perguntas Quinzenal/Mensals</h1>
        <p style="margin: 0; opacity: 0.9;">Gerencie perguntas dos formulários quinzenais/mensais</p>
    </div>
    ...
    <div class="table-card">
        <?php if (empty($perguntas)): ?>
            <div class="empty-state">
                ...
                <p>Comece criando sua primeira pergunta para formulários quinzenais/mensais</p>
