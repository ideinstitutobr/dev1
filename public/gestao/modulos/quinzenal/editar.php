<?php
/**
 * Página: Editar Módulo Quinzenal/Mensal
 * Formulário para editar módulo de avaliação diária
 */
...
if (!$modulo || $modulo['tipo'] !== 'quinzenal_mensal') {
    header('Location: index.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $moduloModel->atualizar($_GET['id'], $dados);
...
$pageTitle = 'Editar Módulo Quinzenal/Mensal';
...
<div class="container">
    <div class="header">
        <h1>✏️ Editar Módulo Quinzenal/Mensal</h1>
        <p style="margin: 5px 0 0 0; opacity: 0.9;">Atualize as informações do módulo</p>
    </div>
    ...
    <div class="form-card">
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="nome" required value="<?php echo htmlspecialchars($modulo['nome']); ?>">
                <div class="help-text">Nome que identifica o módulo na avaliação</div>
            </div>

            <div class="form-group">
                <label>Descrição</label>
                <textarea name="descricao"><?php echo htmlspecialchars($modulo['descricao'] ?? ''); ?></textarea>
            ...
            <div class="form-group-inline">
                <div class="form-group">
                    ...
                    <input type="number" name="total_perguntas" required min="1" value="<?php echo $modulo['total_perguntas']; ?>">
                    <div class="help-text">Quantidade de perguntas deste módulo</div>
                </div>

                <div class="form-group">
                    <label>Peso por Pergunta (%) *</label>
                    <input type="number" name="peso_por_pergunta" required min="0.01" step="0.01" value="<?php echo $modulo['peso_por_pergunta']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="number" name="ordem" required min="1" value="<?php echo $modulo['ordem']; ?>">
                <div class="help-text">Define a ordem em que o módulo aparece no formulário</div>
            </div>

            <div class="form-group">
                <div class="checkbox-group">
                    <input type="checkbox" name="ativo" id="ativo" <?php echo $modulo['ativo'] ? 'checked' : ''; ?>>
