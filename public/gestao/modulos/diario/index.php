<?php
/**
 * Página: Gestão de Módulos Diários
 * Listagem e gerenciamento dos módulos de avaliação diária
 */
...
// Buscar apenas módulos diários
$modulos = $moduloModel->listarAtivos('diario', true); // true = incluir inativos

$pageTitle = 'Gestão de Módulos Diários';
...
<div class="container">
    <div class="header">
        <div>
            <h1>📦 Gestão de Módulos Diários</h1>
            <p style="margin: 5px 0 0 0; opacity: 0.9;">Gerencie os módulos de avaliação diária</p>
        </div>
        <div>
    ...
    <div class="table-container">
        <?php if (empty($modulos)): ?>
            <div class="empty-state">
                ...
                <p>Comece criando seu primeiro módulo de avaliação diária</p>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    <a href="../../perguntas/diario/index.php?modulo_id=<?php echo $modulo['id']; ?>" class="btn btn-success btn-sm">❓ Perguntas</a>
